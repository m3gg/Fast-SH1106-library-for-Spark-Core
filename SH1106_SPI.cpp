...
uint8_t SH1106_SPI::gotoXY(uint8_t x, uint8_t y) 
{
	...
	this->m_Line = y;
    	...
    	this->writeLcd(SH1106_COMMAND, 0xB0 + y);           // Set row ... SH1106_COMMAND is defined as 0
    	this->writeLcd(SH1106_COMMAND, x & 0xF);            // Set lower column address ... SH1106_COMMAND is defined as 0
    	this->writeLcd(SH1106_COMMAND, 0x10 | (x >> 4));    // Set higher column address ... SH1106_COMMAND is defined as 0
